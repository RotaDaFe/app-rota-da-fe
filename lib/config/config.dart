class ConfigData {
  get localDeAtendimento => ["casa de placido", "tribunal"];
  get imagemHomePage => "images/banner1.png";
  get imagemAboutPage => "images/banner1.png";
  get tituloNavBar => "Círio 2025";
  // get tituloNavBar => "Rota da Fé";
  get rodapeTexto =>
